...
const Home = () => {
    const fac = ['Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet', 'Internet']
  return (
    <>
      <Slide
      ...
      <Slide
        ...
        subheader={"We provide a fully equipped kitchen for you to be able to save some money and make your favourite dishes. In the big lounge area with comfy sofas you can meet travelers from all around the world, share experiences and make new friends. Our hostel also offers plenty of computers with 24 hours free internet access and Wi-Fi all over the hostel for you to keep in touch, or plan your next trips."}
        image={image3}
        height={"50%"}
      />
       <Frame header={'Facilities'} subheader={<div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', alignContent: 'center', flexWrap: 'wrap'}}>
            {fac.map(f => <div style={{margin: '1rem'}}>{f}</div>)}
       </div>}/>
        <Slide
        header={"OUR STAFF"}
        subheader={"Our friendly and experienced staff will help you with everything you need, from showing you the best spots, restaurants, bars, clubs and shops to helping you plan your next trip. We know how to fulfill your needs, as we are travelers too."}
        image={image4}
        height={"50%"}
      />
    </>
